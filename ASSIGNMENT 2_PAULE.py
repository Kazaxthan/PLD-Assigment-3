...
def enter_data():
    ...
    if firstname and lastname and street and muni and city and province:
        if firstname and lastname: int=False
        ...
        info = customtkinter.CTkLabel(master= result, text= userinfo, font = ("Times ", 36),text_color="#ADD8E6"  )
        info.grid (row=1, column=0)
        info = customtkinter.CTkLabel(master= result, text= age, font = ("Times", 36),text_color="#ADD8E6"  )
        info.grid (row=3, column=0)
        info = customtkinter.CTkLabel(master= result, text= address, font = ("Times", 36),text_color="#ADD8E6")
        info.grid (row=5, column=0)
        info = customtkinter.CTkLabel(master= result, text= "You're name is", font = ("Times", 24),text_color="#CF9FFF"  )
        info.grid (row=0, column=0)
        info = customtkinter.CTkLabel(master= result, text= "You're age is", font = ("Times", 24),text_color="#CF9FFF"  )
        info.grid (row=2, column=0)
        info = customtkinter.CTkLabel(master= result, text= "You're from", font = ("Times", 24),text_color="#CF9FFF")
...
title_label = customtkinter.CTkLabel(user_info_frame, text="User Infomation", fg_color="#821D1A", corner_radius=34, font= ("arial", 12,"bold"))
...
street_name_label =customtkinter.CTkLabel(address_frame, text="Address", fg_color="#821D1A", corner_radius=34, font= ("arial", 12,"bold") )
